...
import tfidf.indexer.WordSieve;
import tfidf.indexer.reduce.IndexedFile;
...
public class Search {
     ...
     * - fetches the files of interest using boolean tfidf.search
     ...
     * - follows the same processing as the tfidf.indexer:
     *      - exception
     *      - stop word
     *      - canonical form
     * @param interogation
     ...
     * @param token
     * @param indexedFile
     *  - tfidf.mongo indexed file entry (contains the number of all mapped words out of the file)
     * @return
     *  - tf of the token
     */
